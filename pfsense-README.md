...
![DNS Block Rule + Failed nslookup](docs/screenshots/dns-block.png)
...
![HTTP Block Rule + Failed wget](docs/screenshots/http-block.png)
...
![ICMP Rule + Successful Ping](docs/screenshots/icmp-allow.png)
